...
const ELEMENTS = {
    Fire: {
        ...
        quality: 'Dynamic energy that inspires and transforms',
    ...
    Earth: {
        ...
        quality: 'Grounding energy that builds and sustains',
    ...
    Air: {
        ...
        quality: 'Connecting energy that communicates and innovates',
