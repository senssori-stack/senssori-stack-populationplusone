...
const SNAP_KEYS: { label: string; key: string }[] = [
    ...
    { label: 'Dow Jones', key: 'DOW JONES CLOSE' },
...
export default function TimeCapsuleBack(props: Props) {
    ...
    let stateCode = '';
    if (props.hometown && props.hometown.trim()) {
        const extracted = extractStateFromHometown(props.hometown);
        stateCode = extracted || '';
    }
    ...
    // Prepend Zodiac, Birthstone, and Life Path Number as the top rows
